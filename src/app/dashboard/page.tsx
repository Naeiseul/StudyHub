...
export default function Dashboard() {
  ...
  // --- Department Navigation Definitions ---
  const TEACHER_TILES = [
    { id: "students", title: "Students", icon: StudentsGroupIcon, subtitle: "Roster, enrolments & import" },
    { id: "finance", title: "Finance", icon: FinanceIcon, subtitle: "Fee ledger, billing & Paystack" },
    { id: "documents", title: "Documents", icon: DocumentsIcon, subtitle: "Indemnity forms, conduct & letters" },
    { id: "timetable", title: "Timetable", icon: TimetableIcon, subtitle: "Schedules, sessions & venues" },
    { id: "academic-overview", title: "Academic Overview", icon: ModulesIcon, subtitle: "Curriculum, marks & Moodle" },
    { id: "announcements", title: "Announcements", icon: AnnouncementsIcon, subtitle: "Broadcast circulars & notices" },
    { id: "settings", title: "Settings", icon: SettingsIcon, subtitle: "Capacity, academy profile & security" },
  ];
  ...
  const STUDENT_TILES = [
    ...
    { id: "announcements", title: "Announcements", icon: AnnouncementsIcon, subtitle: "Circulars & administrative dates" },
    { id: "settings", title: "Settings", icon: SettingsIcon, subtitle: "Profile & account preferences" },
  ];
  ...
  return (
    <div className="min-h-screen bg-[#fafbfc] text-slate-900 flex flex-col font-sans">
      ...
      <header className="w-full border-b border-slate-200 bg-white px-4 sm:px-8 py-3 flex items-center justify-between sticky top-0 z-30 shadow-sm">
        <div
          onClick={() => {
        ...
        <div className="flex-1 flex flex-col items-center justify-center p-6 sm:p-12 max-w-6xl mx-auto w-full">
          <div className="text-center mb-8 space-y-1">
            ...
            <p className="text-xs sm:text-sm text-slate-500">
              Select an institutional department to access records, services, and operations.
            </p>
          </div>
            ...
            {currentTiles.map((tile) => {
              ...
              return (
                <button
                  ...
                  className="group bg-white border border-slate-200 hover:border-[#b82e2e] rounded-2xl p-6 flex flex-col items-center justify-center text-center shadow-sm hover:shadow-md transition-all duration-200 cursor-pointer min-h-[160px]"
                >
                  <div className="w-14 h-14 rounded-2xl bg-red-50 text-[#b82e2e] flex items-center justify-center mb-3 group-hover:scale-110 transition-transform duration-200">
                    <IconComp className="w-7 h-7" />
                  </div>
                  <h3 className="text-sm font-bold text-slate-900 group-hover:text-[#b82e2e] transition-colors">
                    {tile.title}
                  </h3>
                  <p className="text-[11px] text-slate-400 mt-1 line-clamp-2">{tile.subtitle}</p>
                </button>
              );
            })}
          </div>
